...
module.exports = function(app) {
  ...
  app.post('/api/create-review-request', function(req, res, next) {
    ...
    return createReviewRequests(revs, function(err, reviewRequests) {
      if (err) return next(err);
...
function createReviewRequests(revs, callback) {
...
function createReviewRequest(changeset, callback) {
  var options = {
    commitId: changeset.node
  };
